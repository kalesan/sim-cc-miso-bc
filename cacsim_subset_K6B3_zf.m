function rate = cacsim_subset_K6B3_zf(L, K, SS, S, SNR_dB, varargin)
    % 6-user CC-BF-SCA simulator for beta=2 with zero-forcing precoding
    ...
    for (r = 1:REALIZATIONS)
        ...
        for (i = 1:ITERATIONS)
            ...
            m = solve_socp_beta_K6B3_zf(h, m_p, y_p, SNR, N0, S, beta);
